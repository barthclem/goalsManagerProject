...
/**
 * Created by b@klem on 5/19/16.
 */

public class LineGraphView {
        private double [] array;

        public View getView(Context context,double[] array){
            this.array=array;
            ...
            View view= ChartFactory.getLineChartView(context,dataset,multipleSeriesRenderer);
